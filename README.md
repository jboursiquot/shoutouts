...
This is a sample template for shoutout - Below is a brief explanation of what we have generated for you:

```bash
.
├── Makefile                    <-- Make to automate build
├── README.md                   <-- This instructions file
├── cmd/shoutout                 <-- Source code for a lambda function
...
aws cloudformation describe-stacks \
    --stack-name shoutout --query 'Stacks[].Outputs'
```
